...
import (
	"hoon/KwebBlackBoard/blackboard-server/controllers/apply"
	"hoon/KwebBlackBoard/blackboard-server/controllers/auth"
	"hoon/KwebBlackBoard/blackboard-server/controllers/board"
	"hoon/KwebBlackBoard/blackboard-server/controllers/course"
	"hoon/KwebBlackBoard/blackboard-server/middlewares"
